...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.activeAlarmsListWidget.setContextMenuPolicy(3)  # Qt.CustomContextMenu
        self.activeAlarmsListWidget.customContextMenuRequested.connect(self.open_temporary_alarms_context_menu)
        ...
        self.tradeAlarmsListWidget.setContextMenuPolicy(3)  # Qt.CustomContextMenu
        self.tradeAlarmsListWidget.customContextMenuRequested.connect(self.open_permanent_alarms_context_menu)
        ...
        validator = QDoubleValidator(0.01, 1000000.0, 2)
        self.rangeLineEdit.setValidator(validator)
        ...
        self.saveConfButton = QtWidgets.QPushButton(self.alarmsTab)
        self.saveConfButton.setMinimumSize(QtCore.QSize(0, 25))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        self.saveConfButton.setFont(font)
        self.saveConfButton.setStyleSheet("color: white;  background-color: rgb(100,30,40)")
        self.saveConfButton.setObjectName("saveConfButton")
        self.saveConfButton.clicked.connect(self.save)
        self.priceQueryGridLayout.addWidget(self.saveConfButton, 2, 0, 1, 2)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("assets/images/refresh.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("assets/images/settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("assets/images/mute.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.saveConfButton.setText(_translate("MainWindow", "Save Configurations"))
